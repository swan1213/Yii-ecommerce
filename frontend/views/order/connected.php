...
<!--Input hiden Fied !-->
<input type="hidden" value="<?=$label;?>" id="connected">
    ...
    <div class="col-sm-12">
        <div class="panel panel-default panel-table">
                ...
                <div class="tools">
                    ...
                    <div id="dropdown_delete" class="dropdown icon">
                            ...
                            <ul role="menu" class="dropdown-menu multiple-delete-dropdown">
                                <li><a id="" data-toggle="modal" data-target="#connect-order-delete-modal-warning" class="btn btn-default customPeople custom_delete_btn">Delete</a></li>
                            </ul>
                        </div>
                </div>
            </div>
            <div class="panel-body table-responsive" style="width: 100%">
                ...
                <table id="order_connected_table" class="table table-striped table-hover table-fw-widget" style="width:100%">
                    <thead>
                    <tr>
                        <th>
...
<div id="connect-order-delete-modal-warning" tabindex="-1" role="dialog" class="modal fade">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <h3>Warning!</h3>
                    <p>Are you sure you want to delete all selected Orders !</p>
                    <div class="xs-mt-50">
                        <button type="button" data-dismiss="modal" class="btn btn-space btn-default">Cancel</button>
                        <button type="button" id="connect_order_delete_button" class="btn btn-space btn-warning">Proceed</button>
                    </div>
                </div>
            </div>
