...
$this->title = 'Add Your WooCommerce Store';
                    ...
                    <form id="woocommerce-authorize-form" action="#" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" class="form-horizontal group-border-dashed">
                        <div class="form-group no-padding main-title">
                            <div class="col-sm-12">
                                ...
                                <p>To integrate WooCommerce store with Elliot, you'll need to Enable the Rest API<b> WooCommerce > Settings > API:</b></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">WooCommerce Store Url *</label>
...
<?php
    $this->registerJsFile('@web/js/store/woocommerce.js', ['depends' => [yii\web\JqueryAsset::className()]]);
?>
