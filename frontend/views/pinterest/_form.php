    ...
    <div class="col-md-12 fuelux">
        <div class="block-wizard panel panel-default">
            <div id="wizard-store-connection" class="wizard wizard-ux">
                <ul class="steps">
                    <li data-step="1" class="active">Create Board<span class="chevron"></span></li>
                </ul>
                <div class="step-content">
                    <input id="user_id" type="hidden" value="<?= $user_id; ?>" />
                    <input id="board_id" type="hidden" value="<?= $id; ?>" />
                    <form action="#" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" class="form-horizontal group-border-dashed">
                        <div class="form-group row no-margin no-padding main-title">
                            <div class="col-sm-12">
                                <p> To get a Pinterest Access Token. Please follow this <a target="_blank" href="https://developers.pinterest.com/tools/access_token/?">link</a>.</p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Access Token</label>
                            <div id="p_token" class="col-sm-6">
                                <input  name="token" type="text" class="form-control customer_validate" placeholder="Please Enter Value" value="<?=$token?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Board Name</label>
                            <div id="p_board_name" class="col-sm-6">
                                <input  name="board_name" type="text" class="form-control customer_validate" placeholder="Please Enter Value" value="<?=$board_name?>">
                            </div>
                        </div>
                        <div>
                            <div class="col-md-6">
                                            ...
                                            foreach ($category_list as $single_category) {
                                                ...
                                                $element = "<li>
                                                                <div class='be-checkbox'>
                                                                        <input class='p_categories' id='chk_{$single_category->id}' type='checkbox' name='categories[]' value='{$single_category->id}' $checked>
                                    ...
                                    if(!empty($countries)) {
                                        foreach ($countries as $country) { ?>
                                            <div class="be-checkbox inline col-sm-6 col-md-4 col-lg-3 margin-left-0">
                                                <input class="p_countries" id="<?= $country->sortname; ?>"
                ...
                <div class="form-group">
                    <div class="col-sm-12" style="padding-top:30px;padding-left:30px;">
                        <button class="btn btn-default btn-space"><a href='/pinterest'>Cancel</a></button>
                    <?php if ($id == 0) { ?>
                        <input type="submit" class="btn btn-space btn-primary" id="pinterest_board_create" value="Save">
                    <?php } else { ?>
                        <input type="submit" class="btn btn-space btn-primary" id="pinterest_board_update" value="Update">
                    <?php } ?>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <p id="pinterest_ajax_msg">Success! Your feed has been created successfully.</p>
                    <div class="xs-mt-50">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <p id="pinterest_ajax_msg_eror">Error Something went wrong. Please try again</p>
                    <div class="xs-mt-50">
