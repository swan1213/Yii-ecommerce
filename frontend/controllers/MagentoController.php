...
class MagentoController extends \yii\web\Controller
{
    /**
     * @inheritdoc
     */
    public function behaviors() {
        return [
            'access' => [
                ...
                'only' => ['index','login', 'magento-customer-create', 'magento-customer-address-update', 'magento-order-create', 'magento-product-create', 'test'],
                'rules' => [
                    [
                        /* action hit without log-in */
                        'actions' => ['login', 'magento-customer-create', 'magento-customer-address-update', 'magento-order-create', 'magento-product-create', 'test'],
                        'allow' => true,
                        'roles' => ['?'],
                    ],
                    [
                        /* action hit only with log-in */
                        'actions' => ['index', 'login', 'magento-customer-create', 'magento-customer-address-update', 'magento-order-create', 'magento-product-create'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionMagentoConfiguration() {
        return $this->render('magentoconfiguration');
    }
    ...
    public function actionMagentoCustomerCreate() {
        ...
        foreach ($user_connections as $_userConnection){
            ...
            $magento_shop = $magentoClientInfo['magento_soap_url'];
