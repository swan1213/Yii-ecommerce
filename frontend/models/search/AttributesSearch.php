 ...
 */
class AttributesSearch extends Attribution
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['id', 'user_id'], 'integer'],
            [['name', 'label', 'description', 'attribution_type', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    {
        $query = Attribution::find()->where(['user_id' => $userId]);
