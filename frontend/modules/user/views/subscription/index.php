...
$this->title = "User Subscription Plans";
...
//$subscriptions=\Stripe\Subscription::all(array('limit'=>1000));
//$subscriptions=Stripe\Customer::all(array("limit" => 10000));
////$subscriptions=\Stripe\Invoice::all(array("limit" => 1000));
//$s = count($subscriptions->__toArray(true));
//echo"<br>";
//$s = $subscriptions->__toArray(true);
//echo'<pre>';
//print_r($s);
//die;
...
$this->params['breadcrumbs'][] = 'User Subscriptions';
...
<div class="main-content container-fluid">
    <div class="page-head">
        <h2 class="page-head-title"><?= Html::encode('Plans & Pricing') ?></h2>
    ...
    <div class="row pricing-tables">
        <!--subscription plans are showing acc to range -->
        <?php
        foreach ($stripe_plan_data as $plans) {
            $id = $plans['id'];
            $amount = $plans['amount'] / 100;
            $prefix_plans = substr($id, 0, 7);
            if ($prefix_plans != 'channel') {
                if (in_array($plans['amount'], range(0, 10000))) {
                    ?>
                    <div class="col-md-3 hideplans">
                        <div class="pricing-table pricing-table-primary">
                            ...
                            <div class="pricing-table-title"><?php echo $plans['name']; ?></div>
                            <div class="panel-divider panel-divider-xl"></div>
                            <div class="pricing-table-price"><span class="currency">$</span><span class="value"><?php echo $amount; ?></span><span class="frecuency">/mo</span></div>
                            <ul class="pricing-table-features">
                                <li><?php echo $plans['statement_descriptor']; ?></li>
                            </ul>

                            <form action="/user/subscription/payment" method="POST">
                                <input type="hidden" name="amount" value="<?php echo $plans['amount']; ?>">
                                    <input type="hidden" name="plan_name" value="<?php echo $plans['id']; ?>">
                                        <script
                                            src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                                            data-key="pk_test_Jzm5jBWhzz982IyyWQ52HgPo"
                                            data-amount="<?php echo $plans['amount']; ?>"
                                            data-name="<?php echo $plans['name']; ?>"
                                            data-description="<?php echo $plans['statement_descriptor']; ?>"
                                    ...
                                    <?php } elseif ((in_array($plans['amount'], range(10000, 30000)))) { ?>
                                        <div class="col-md-3 hideplans">
                                            <div class="pricing-table pricing-table-warning">
                                                ...
                                                <form action="/user/subscription/payment" method="POST">
                                                    <input type="hidden" name="amount" value="<?php echo $plans['amount']; ?>">
                                                        ...
                                                        <?php } elseif ((in_array($plans['amount'], range(30000, 50000)))) { ?>
                                                            <div class="col-md-3 hideplans">
                                                                <div class="pricing-table pricing-table-success">
                                                                    ...
                                                                    <form action="/user/subscription/payment" method="POST">
                                                                        <input type="hidden" name="amount" value="<?php echo $plans['amount']; ?>">
                                                                            ...
                                                                            <?php } elseif((in_array($plans['amount'], range(80000, 100000)))) { ?>
																			<div class="col-md-3">
																			...
																			<?php } elseif((in_array($plans['amount'], range(1200000, 1300000)))) {
                                                                                ?>
                                                                                <div class="col-md-3">
                                                                                    <div class="pricing-table pricing-table-success">
                                                                                        <div class="pricing-table-image">
                                                                                        ...
                                                                                        <div class="pricing-table-title"><?php echo $plans['name']; ?></div>
                                                                                        <div class="panel-divider panel-divider-xl"></div>
                                                                                        <div class="pricing-table-price"><span class="currency">$</span><span class="value"><?php echo number_format($amount,0,'',','); ?></span><span class="frecuency">/mo</span></div>
                                                                                        <ul class="pricing-table-features">
                                                                                            <li><?php echo $plans['statement_descriptor']; ?></li>
                                                                                        </ul>
                                                                                        <form action="/user/subscription/payment" method="POST">
